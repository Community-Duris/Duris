...
SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='account_bound_rewards' AND (
 (ordinal_position=1 AND column_name='id' AND data_type='bigint' AND column_type LIKE '%unsigned' AND is_nullable='NO' AND extra LIKE '%auto_increment%') OR
 ...
 (ordinal_position=3 AND column_name='reward_vnum' AND data_type='int' AND column_type NOT LIKE '%unsigned' AND is_nullable='NO' AND column_default='36419') OR
 (ordinal_position=4 AND column_name='template_version' AND data_type='smallint' AND column_type LIKE '%unsigned' AND is_nullable='NO' AND column_default='0') OR
 (ordinal_position=5 AND column_name='template_json' AND data_type='longtext' AND is_nullable='YES' AND UPPER(COALESCE(column_default,'NULL'))='NULL' AND collation_name='utf8mb4_unicode_ci') OR
 (ordinal_position=6 AND column_name='display_name' AND column_type='varchar(512)' AND is_nullable='NO' AND column_default IN ('','\'\'') AND collation_name='utf8mb4_unicode_ci') OR
 (ordinal_position=7 AND column_name='granted_by' AND column_type='varchar(50)' AND is_nullable='NO' AND column_default IN ('','\'\'') AND collation_name='utf8mb4_unicode_ci') OR
 (ordinal_position=8 AND column_name='created_at' AND data_type='timestamp' AND is_nullable='YES' AND UPPER(column_default) LIKE 'CURRENT_TIMESTAMP%') OR
 (ordinal_position=9 AND column_name='updated_at' AND data_type='timestamp' AND is_nullable='YES' AND UPPER(column_default) LIKE 'CURRENT_TIMESTAMP%' AND LOWER(extra) LIKE '%on update current_timestamp%') OR
 (ordinal_position=10 AND column_name='expires_at' AND data_type='datetime' AND is_nullable='YES' AND UPPER(COALESCE(column_default,'NULL'))='NULL') OR
 (ordinal_position=11 AND column_name='remaining_pwipes' AND data_type='int' AND column_type LIKE '%unsigned' AND is_nullable='YES' AND UPPER(COALESCE(column_default,'NULL'))='NULL')
);")
...
SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='account_bound_reward_summons' AND (
 (ordinal_position=1 AND column_name='grant_id' AND data_type='bigint' AND column_type LIKE '%unsigned' AND is_nullable='NO') OR
 (ordinal_position=2 AND column_name='pid' AND data_type='int' AND column_type LIKE '%unsigned' AND is_nullable='NO') OR
 (ordinal_position=3 AND column_name='last_summoned_at' AND data_type='datetime' AND is_nullable='NO' AND UPPER(column_default) LIKE 'CURRENT_TIMESTAMP%') OR
...
SELECT COUNT(*) FROM information_schema.columns WHERE table_schema=DATABASE() AND table_name='account_bound_reward_pwipe_state' AND (
 (ordinal_position=1 AND column_name='id' AND data_type='tinyint' AND column_type LIKE '%unsigned' AND is_nullable='NO') OR
 (ordinal_position=2 AND column_name='last_processed_at' AND data_type='datetime' AND is_nullable='YES' AND UPPER(COALESCE(column_default,'NULL'))='NULL')
);")
...
WHERE kcu.constraint_schema=DATABASE() AND rc.update_rule IN ('NO ACTION','RESTRICT') AND rc.delete_rule='CASCADE' AND (
