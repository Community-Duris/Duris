...
#define MAX_CMD 859 // current number of commands, including the final newline
...
/* Shops: must cover the largest trade list in world.shp; boot logs the needed value. */
#define MAX_TRADE 16
