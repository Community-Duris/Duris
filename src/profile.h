...
#define PROFILE_START(var)                                                       \
	{                                                                        \
		...
		{                                                                \
			var##_profile_beg = clock();                             \
			var##_profile_total_outside +=                           \
				(double)(var##_profile_beg - var##_profile_end); \
		}                                                                \
	}
...
#define PROFILE_END(var)                                                         \
	{                                                                        \
		...
		{                                                                \
			var##_profile_end = clock();                             \
			var##_profile_total_inside +=                            \
				(double)(var##_profile_end - var##_profile_beg); \
			var##_profile_total++;                                   \
		}                                                                \
	}

#define PROFILE_SAVE(var)                                                                \
	save_profile_data(#var, var##_profile_total_inside, var##_profile_total_outside, \
			  var##_profile_total);
...
extern void save_profile_data(const char *name, double total_inside, double total_outside,
			      unsigned total);
