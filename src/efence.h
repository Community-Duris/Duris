...
#define EF_FN_PROT_START                                                                                                                                                                               \
	const void *EF_RET_ADDR = __builtin_return_address(0);                                                                                                                                             \
	{

#define EF_FN_PROT_END                                                                                                                                                                                 \
	}                                                                                                                                                                                                  \
	EF_ASSERT(__builtin_return_address(0) == EF_RET_ADDR);

#define EF_FN_PROT_RET(EXPR)                                                                                                                                                                           \
	do                                                                                                                                                                                                 \
	{                                                                                                                                                                                                  \
		EF_ASSERT(__builtin_return_address(0) == EF_RET_ADDR);                                                                                                                                         \
		return (EXPR);                                                                                                                                                                                 \
	} while (0)
#define EF_FN_PROT_RET_VOID()                                                                                                                                                                          \
	do                                                                                                                                                                                                 \
	{                                                                                                                                                                                                  \
		EF_ASSERT(__builtin_return_address(0) == EF_RET_ADDR);                                                                                                                                         \
		return;                                                                                                                                                                                        \
...
#define EF_FN_PROT_START                                                                                                                                                                               \
	int aiEF_PROT[4] = {'E', 'F', 'P', 'R'};                                                                                                                                                           \
	{

#define EF_FN_PROT_END                                                                                                                                                                                 \
	}                                                                                                                                                                                                  \
	EF_ASSERT('E' == aiEF_PROT[0] && 'F' == aiEF_PROT[1] && 'P' == aiEF_PROT[2] && 'R' == aiEF_PROT[3]);
 ...
 */
#define CA_REF(NAME, INDEX) NAME[EF_ASSERT((NAME##_checkedidx = (INDEX)) < NAME##_checkedsize), NAME##_checkedidx]
