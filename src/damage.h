...
#define RAWDAM_NOWARD     BIT_29
#define RAWDAM_DEFAULT    (RAWDAM_TRANCEVAMP | RAWDAM_BTXVAMP | RAWDAM_SHRTVMP | RAWDAM_HOLYSAC | RAWDAM_SANCTUARY | RAWDAM_IMPRISON | RAWDAM_VINES)

#define SPLDAM_ALLGLOBES SPLDAM_MINORGLOBE | SPLDAM_GLOBE | SPLDAM_SPIRITWARD | SPLDAM_GRSPIRIT
