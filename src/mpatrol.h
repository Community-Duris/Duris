...
#define MP_FLG_CHECKALL      (MP_FLG_CHECKALLOCS | MP_FLG_CHECKREALLOCS | MP_FLG_CHECKFREES | MP_FLG_CHECKMEMORY)
...
#define MP_FLG_LOGALL        (MP_FLG_LOGALLOCS | MP_FLG_LOGREALLOCS | MP_FLG_LOGFREES | MP_FLG_LOGMEMORY)
...
#define MP_FLG_SHOWALL       (MP_FLG_SHOWMAP | MP_FLG_SHOWSYMBOLS | MP_FLG_SHOWFREE | MP_FLG_SHOWFREED | MP_FLG_SHOWUNFREED)
...
typedef void (*__mp_prologuehandler)(MP_CONST void *, size_t, size_t, MP_CONST char *, MP_CONST char *, unsigned long, MP_CONST void *);
typedef void (*__mp_epiloguehandler)(MP_CONST void *, MP_CONST char *, MP_CONST char *, unsigned long, MP_CONST void *);
typedef void (*__mp_nomemoryhandler)(MP_CONST char *, MP_CONST char *, unsigned long, MP_CONST void *);
...
#define malloc(l)         __mp_alloc((l), 0, MP_AT_MALLOC, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define calloc(l, n)      __mp_alloc((l) * (n), 0, MP_AT_CALLOC, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define memalign(a, l)    __mp_alloc((l), (a), MP_AT_MEMALIGN, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define valloc(l)         __mp_alloc((l), 0, MP_AT_VALLOC, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define pvalloc(l)        __mp_alloc((l), 0, MP_AT_PVALLOC, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define alloca(l)         __mp_alloc((l), 0, MP_AT_ALLOCA, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define strdup(p)         __mp_strdup((p), 0, MP_AT_STRDUP, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define strndup(p, l)     __mp_strdup((p), (l), MP_AT_STRNDUP, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define strsave(p)        __mp_strdup((p), 0, MP_AT_STRSAVE, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define strnsave(p, l)    __mp_strdup((p), (l), MP_AT_STRNSAVE, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define strdupa(p)        __mp_strdup((p), 0, MP_AT_STRDUPA, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define strndupa(p, l)    __mp_strdup((p), (l), MP_AT_STRNDUPA, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define realloc(p, l)     __mp_realloc((p), (l), 0, MP_AT_REALLOC, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define reallocf(p, l)    __mp_realloc((p), (l), 0, MP_AT_REALLOCF, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define recalloc(p, l, n) __mp_realloc((p), (l) * (n), 0, MP_AT_RECALLOC, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define expand(p, l)      __mp_realloc((p), (l), 0, MP_AT_EXPAND, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define free(p)           __mp_free((p), MP_AT_FREE, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define cfree(p, l, n)    __mp_free((p), MP_AT_CFREE, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define dealloca(p)       __mp_free((p), MP_AT_DEALLOCA, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define xmalloc(l)        __mp_alloc((l), 0, MP_AT_XMALLOC, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define xcalloc(l, n)     __mp_alloc((l) * (n), 0, MP_AT_XCALLOC, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define xstrdup(p)        __mp_strdup((p), 0, MP_AT_XSTRDUP, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define xrealloc(p, l)    __mp_realloc((p), (l), 0, MP_AT_XREALLOC, MP_FUNCNAME, __FILE__, __LINE__, NULL, 0, 0)
#define xfree(p)          __mp_free((p), MP_AT_XFREE, MP_FUNCNAME, __FILE__, __LINE__, 0)

#define memset(p, c, l)     __mp_setmem((p), (l), (unsigned char)(c), MP_AT_MEMSET, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define bzero(p, l)         (void)__mp_setmem((p), (l), 0, MP_AT_BZERO, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define memccpy(q, p, c, l) __mp_copymem((p), (q), (l), (unsigned char)(c), MP_AT_MEMCCPY, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define memcpy(q, p, l)     __mp_copymem((p), (q), (l), 0, MP_AT_MEMCPY, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define memmove(q, p, l)    __mp_copymem((p), (q), (l), 0, MP_AT_MEMMOVE, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define bcopy(p, q, l)      (void)__mp_copymem((p), (q), (l), 0, MP_AT_BCOPY, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define memchr(p, c, l)     __mp_locatemem((p), (l), NULL, (size_t)(c), MP_AT_MEMCHR, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define memmem(p, l, q, m)  __mp_locatemem((p), (l), (q), (m), MP_AT_MEMMEM, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define memcmp(p, q, l)     __mp_comparemem((p), (q), (l), MP_AT_MEMCMP, MP_FUNCNAME, __FILE__, __LINE__, 0)
#define bcmp(p, q, l)       __mp_comparemem((p), (q), (l), MP_AT_BCMP, MP_FUNCNAME, __FILE__, __LINE__, 0)

#define MP_MALLOC(p, l, t)  (p = (t *)__mp_alloc((l) * sizeof(t), MP_ALIGN(t), MP_AT_XMALLOC, MP_FUNCNAME, __FILE__, __LINE__, #t, sizeof(t), 0))
#define MP_CALLOC(p, l, t)  (p = (t *)__mp_alloc((l) * sizeof(t), MP_ALIGN(t), MP_AT_XCALLOC, MP_FUNCNAME, __FILE__, __LINE__, #t, sizeof(t), 0))
#define MP_STRDUP(p, s)     (p = __mp_strdup((s), 0, MP_AT_XSTRDUP, MP_FUNCNAME, __FILE__, __LINE__, 0))
#define MP_REALLOC(p, l, t) (p = (t *)__mp_realloc((p), (l) * sizeof(t), MP_ALIGN(t), MP_AT_XREALLOC, MP_FUNCNAME, __FILE__, __LINE__, #t, sizeof(t), 0))
#define MP_FREE(p)                                                                                                                                                                                     \
	do                                                                                                                                                                                                 \
	{                                                                                                                                                                                                  \
...
#define __mp_vlocprintf(m, v) __mp_vprintfwithloc(MP_FUNCNAME, __FILE__, __LINE__, (m), (v))
...
extern "C"
{
	...
	void                *__mp_alloc(size_t, size_t, __mp_alloctype, MP_CONST char *, MP_CONST char *, unsigned long, MP_CONST char *, size_t, size_t);
	char                *__mp_strdup(MP_CONST char *, size_t, __mp_alloctype, MP_CONST char *, MP_CONST char *, unsigned long, size_t);
	void                *__mp_realloc(void *, size_t, size_t, __mp_alloctype, MP_CONST char *, MP_CONST char *, unsigned long, MP_CONST char *, size_t, size_t);
	void                 __mp_free(void *, __mp_alloctype, MP_CONST char *, MP_CONST char *, unsigned long, size_t);
	void                *__mp_setmem(void *, size_t, unsigned char, __mp_alloctype, MP_CONST char *, MP_CONST char *, unsigned long, size_t);
	void                *__mp_copymem(MP_CONST void *, void *, size_t, unsigned char, __mp_alloctype, MP_CONST char *, MP_CONST char *, unsigned long, size_t);
	void                *__mp_locatemem(MP_CONST void *, size_t, MP_CONST void *, size_t, __mp_alloctype, MP_CONST char *, MP_CONST char *, unsigned long, size_t);
	int                  __mp_comparemem(MP_CONST void *, MP_CONST void *, size_t, __mp_alloctype, MP_CONST char *, MP_CONST char *, unsigned long, size_t);
	...
	void                 __mp_printfwithloc(MP_CONST char *, MP_CONST char *, unsigned long, MP_CONST char *, ...);
	void                 __mp_vprintfwithloc(MP_CONST char *, MP_CONST char *, unsigned long, MP_CONST char *, va_list);
...
#if defined(__STDC_VERSION__) && (__STDC_VERSION__ == 199901L)
#define __mp_locprintf(...) __mp_printfwithloc(MP_FUNCNAME, __FILE__, __LINE__, __VA_ARGS__)
#elif defined(__GNUC__)
#define __mp_locprintf(a...) __mp_printfwithloc(MP_FUNCNAME, __FILE__, __LINE__, a)
#else  /* __STDC_VERSION__ && __GNUC__ */
static void __mp_locprintf(MP_CONST char *m, ...)
{
	va_list v;
...
#else  /* __STDC_VERSION__ && __GNUC__ */
static int __mp_printf(MP_CONST char *s, ...) { return 0; }

static void __mp_printfwithloc(MP_CONST char *s, MP_CONST char *t, unsigned long u, MP_CONST char *m, ...) {}
...
namespace std
{
	...
	MP_INLINE
	new_handler set_new_handler(new_handler h) throw() { return (new_handler)__mp_nomemory((__mp_nomemoryhandler)h); }
...
MP_INLINE
void *operator new(size_t l, MP_CONST char *s, MP_CONST char *t, unsigned long u) throw(std::bad_alloc)
{
	void *p;
...
MP_INLINE
void *operator new(size_t l, MP_CONST char *s, MP_CONST char *t, unsigned long u, MP_CONST std::nothrow_t &) throw() { return __mp_alloc(l, 0, MP_AT_NEW, s, t, u, NULL, 0, 0); }
...
MP_INLINE
void *operator new[](size_t l, MP_CONST char *s, MP_CONST char *t, unsigned long u, MP_CONST std::nothrow_t &) throw() { return __mp_alloc(l, 0, MP_AT_NEWVEC, s, t, u, NULL, 0, 0); }
...
MP_INLINE
void operator delete(void *p, MP_CONST std::nothrow_t &) throw()
{
	char         *s, *t;
	unsigned long u;
