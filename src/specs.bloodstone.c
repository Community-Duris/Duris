...
int bs_robber(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		...
		case 4:
			...
			return TRUE;
		case 5:
			act("$n searches a body just harvested from the ground.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		default:
			return FALSE;
	}
...
int bs_sickguard(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		...
		case 2:
			...
			return TRUE;
		case 3:
			act("$n rolls over onto $s side, trying to get comfortable.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 4:
			do_action(ch, 0, CMD_COUGH);
		default:
...
int bs_armor(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n turns towards the back of the shop and yells 'More shields!'", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 2:
			...
			return TRUE;
		case 3:
			act("$n drums $s fingers upon the counter looking very impatient.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 4:
			do_action(ch, 0, CMD_COUGH);
		default:
...
int bs_eatery(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n begins wiping stirge grease off the countertop.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 2:
			...
			return TRUE;
		case 3:
			act("$n tosses a couple more stirge into an oven.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 4:
			do_action(ch, 0, CMD_HUM);
		default:
...
int bs_weapon(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n runs $s thumb down the blade of a saber.", TRUE, ch, 0, 0, TO_ROOM);
...
int bs_stable(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		...
		case 2:
			...
			return TRUE;
		case 3:
			act("$n reaches over and begins to groom a horse.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 4:
...
int bs_inn(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		...
		case 2:
			...
			return TRUE;
		case 3:
			act("$n straightens a picture hanging on the wall.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 4:
			do_action(ch, 0, CMD_WHISTLE);
		default:
...
int bs_youngm(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		...
		case 3:
			...
			return TRUE;
		case 4:
			act("$n runs $s tongue down the woman's bare back.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 5:
			act("$n continues to move $s hands slowly over the woman.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		default:
			return FALSE;
	}
...
int bs_youngw(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		...
		case 4:
			...
			return TRUE;
		case 5:
			act("$n looks over at you and gives a suggestive wink.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		default:
			return FALSE;
	}
...
int bs_prostitute(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		...
		case 3:
			...
			return TRUE;
		case 4:
			act("$n walks over to you and feels your muscles.", TRUE, ch, 0, 0, TO_ROOM);
...
int bs_banker(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n makes tall stacks out of platinum coins.", TRUE, ch, 0, 0, TO_ROOM);
		...
		case 2:
			...
			return TRUE;
		case 3:
			act("$n begins to write down some figures in the ledger.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 4:
...
int bs_veriallo(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		...
		case 2:
			...
			return TRUE;
		case 3:
			act("$n stocks the wall behind $m with huge barrels.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 4:
			mobsay(ch, "Now, how can I be of service?");
			do_action(ch, 0, CMD_SMILE);
...
int bs_mslave(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		...
		case 2:
			...
			return TRUE;
		case 3:
			act("$n runs over to you to attend to your needs.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 4:
...
int bs_fslave(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		...
		case 2:
			...
			return TRUE;
		case 3:
			act("$n runs $s fingers through your coarse, sweaty hair.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 4:
...
int bs_antimaster(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			mobsay(ch, "If you wish to have your own statue, you must show me your worth.");
			do_action(ch, 0, CMD_CACKLE);
			return TRUE;
		case 2:
			...
			return TRUE;
		case 3:
			act("$n dazzles you with a brilliant sword move.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 4:
			mobsay(ch, "Black-hearted are we, hated by most.  They will feel our might.");
			do_action(ch, 0, CMD_CACKLE);
		default:
			return FALSE;
	}
...
int bs_antishop(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			mobsay(ch, "Made from the finest alloys, ready to work for the evil hand.");
			do_action(ch, 0, CMD_CACKLE);
			return TRUE;
		case 2:
			...
			return TRUE;
		case 3:
			act("$n hangs a few more weapons upon the wall.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 4:
	...
	if (ch->in_room == real_room(7680))
	{
		if (cmd == CMD_NORTH)
		{
			if (IS_PC(pl))
			{
				...
				mobsay(ch, "You cannot enter the Baron's realm without first paying homage to my lord!");
			...
			else
			{
				...
				mobsay(ch, "'Tis wise of you to part with gold so you do not have to part with your head.");
				mobsay(ch, "Welcome to the Barony of Bloodstone.");
				act("$n steps aside to let $N pass northwards.", TRUE, ch, 0, pl, TO_NOTVICT);
				char_from_room(pl);
		...
		else if (cmd == CMD_GIVE)
		{
			...
			else
			{
				mobsay(ch, "'Tis wise of you to part with gold so you do not have to part with your head.");
				mobsay(ch, "Welcome to the Barony of Bloodstone.");
				act("$n steps aside to let you pass northwards.", FALSE, ch, 0, pl, TO_VICT);
				act("$n steps aside to let $N pass northwards.", TRUE, ch, 0, pl, TO_NOTVICT);
				char_from_room(pl);
				char_to_room(pl, real_room(7681), 0);
				act("$n arrives from the south.", TRUE, pl, 0, 0, TO_ROOM);
		...
		else
		{
			switch (number(0, 80))
			{
				...
				case 1:
					...
					mobsay(ch, "You must pay me a tribute of 15 gold coins to the mighty Baron to enter.");
					return TRUE;
				case 2:
...
int bs_acolyte(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		...
		case 1:
			...
			return TRUE;
		case 2:
			act("$n looks around the room as if $e was bored.", TRUE, ch, 0, 0, TO_ROOM);
			do_action(ch, 0, CMD_SMILE);
			return TRUE;
		default:
			return FALSE;
...
int bs_clericpriest(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	{
		case 0:
			act("$n slaps an acolyte viciously across the face.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 1:
			act("$n notices an acolyte is not paying attention.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		default:
			return FALSE;
	}
...
int bs_thiefmaster(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n picks your pockets, and gives you back the stolen items.", TRUE, ch, 0, 0, TO_ROOM);
...
int bs_assmaster(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n displays a deadly technique with a dagger.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 2:
		...
		case 3:
			do_action(ch, 0, CMD_CACKLE);
			mobsay(ch, "Inhabitants of Verzanan squeal like pigs when put under the knife.");
			return TRUE;
		default:
			return FALSE;
	}
...
int bs_magemaster(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n summons a horrid demon, and then sends it back to its own dimension.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 2:
			mobsay(ch, "It is hard at first, but once a powerful spell caster you will rule the world.");
			do_action(ch, 0, CMD_CACKLE);
			return TRUE;
		case 3:
			do_action(ch, 0, CMD_CACKLE);
			mobsay(ch, "The magic that you learn here is to be used for the cause of evil.");
			return TRUE;
		default:
			return FALSE;
	}
...
int bs_thiefshop(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n stocks the shelves behind $m with some thief wares.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 2:
...
int bs_assshop(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n stocks the shelves behind $m with some wares.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 2:
...
int bs_necroshop(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n stocks the shelves behind $m with some blackmoore.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 2:
...
int bs_mageshop(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n stocks the shelves behind $m with some scrolls.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 2:
...
int bs_payton(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	switch (number(0, 100))
	{
		case 0:
			...
			return TRUE;
		case 1:
			act("$n stocks the shelves behind $m with some bottles.", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		case 2:
...
int bs_bouncer(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	if (ch->in_room == real_room(7431))
	{
		if (cmd == CMD_SOUTH)
		{
			if (IS_PC(pl))
			{
				act("$n stops you from entering the building to the south.", FALSE, ch, 0, pl, TO_VICT);
				act("$n stops $N from entering the building to the south.", TRUE, ch, 0, pl, TO_NOTVICT);
		...
		else
		{
			switch (number(0, 60))
			{
				...
				case 2:
					...
					return TRUE;
				case 3:
					mobsay(ch, "HA!  Laughter is what you will hear if you shed those clothes.");
					return TRUE;
				case 4:
...
int bs_undead_die(P_char ch, P_char pl, int cmd, char *arg)
{
	 ...
	 */
	if (cmd == CMD_DEATH)
		act("$n turns into a black vapor and seeps into the ground.", FALSE, ch, 0, 0, TO_ROOM);
	return FALSE;
}
...
int bs_follow_22432(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22431)) && (GET_RNUM(ch) == real_mobile(22432)))
		{
			add_follower(ch, tch);
...
int bs_follow_22434(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22433)) && (GET_RNUM(ch) == real_mobile(22434)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_follow_22436(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22435)) && (GET_RNUM(ch) == real_mobile(22436)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_follow_22456(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22455)) && (GET_RNUM(ch) == real_mobile(22456)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_follow_22458(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22457)) && (GET_RNUM(ch) == real_mobile(22458)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_follow_22461(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22460)) && (GET_RNUM(ch) == real_mobile(22461)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_follow_22466(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22465)) && (GET_RNUM(ch) == real_mobile(22466)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_follow_22467(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22465)) && (GET_RNUM(ch) == real_mobile(22467)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_follow_22508(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22511)) && (GET_RNUM(ch) == real_mobile(22508)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_follow_22509(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22511)) && (GET_RNUM(ch) == real_mobile(22509)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_follow_22510(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22511)) && (GET_RNUM(ch) == real_mobile(22510)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_follow_22512(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22511)) && (GET_RNUM(ch) == real_mobile(22512)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_follow_22513(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	LOOP_THRU_PEOPLE(tch, ch)
	{
		if (IS_NPC(tch) && (GET_RNUM(tch) == real_mobile(22511)) && (GET_RNUM(ch) == real_mobile(22513)))
		{
			add_follower(ch, tch);
			group_add_member(tch, ch);
			return TRUE;
...
int bs_guildguard_necro(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	if ((ch->in_room == real_room(7880)) && (cmd == CMD_WEST))
	{
		if (GET_CLASS(pl) == CLASS_NECROMANCER)
		{
			...
			act("You enter the guild, nodding to $n as you pass.", FALSE, ch, 0, pl, TO_VICT);
			act("$N enters the guild, nodding to $n as $E passes.", TRUE, ch, 0, pl, TO_NOTVICT);
			char_from_room(pl);
		...
		{
			do_action(ch, 0, CMD_SMIRK);
			mobsay(ch, "I don't think you have the proper knowledge to pass this unholy seal.");
			return TRUE;
		}
	}
	return FALSE;
...
int bs_guildguard_thief(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	if ((ch->in_room == real_room(7864)) && (cmd == CMD_WEST))
	{
		...
		{
			act("$n looks you over carefully, and then turns to move a huge boulder to one side.", FALSE, ch, 0, pl, TO_VICT);
			act("$n eyes $N thoughtfully before turning to move a huge boulder to one side.", TRUE, ch, 0, pl, TO_NOTVICT);
		...
		{
			act("$n shakes $s head in disgust and points $s finger upwards.", TRUE, ch, 0, 0, TO_ROOM);
			act("$n grunts at you, 'This is no place for you.'", FALSE, ch, 0, pl, TO_VICT);
			act("$n grunts at $N, 'This is no place for you.'", TRUE, ch, 0, pl, TO_NOTVICT);
			return TRUE;
		}
	}
	return FALSE;
...
int bs_guildguard_sorcconj(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	{
		if ((GET_CLASS(pl) == CLASS_SORCERER) || (GET_CLASS(pl) == CLASS_SUMMONER) || (GET_CLASS(pl) == CLASS_CONJURER))
		{
		...
		else
		{
			...
			act("$n growls, 'Leave now insect, these chains will not hold my fury!'", TRUE, ch, 0, 0, TO_ROOM);
			return TRUE;
		}
	}
	return FALSE;
...
int bs_guildguard_clersham(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	if ((ch->in_room == real_room(7817)) && (cmd == CMD_DOWN))
	{
		...
		{
			act("$n bows slightly, and allows you to pass.", FALSE, ch, 0, pl, TO_VICT);
			act("$n bows slightly, and allows $N to pass.", TRUE, ch, 0, pl, TO_NOTVICT);
			act("You enter the guild.", FALSE, ch, 0, pl, TO_VICT);
			act("$N enters the guild.", TRUE, ch, 0, pl, TO_NOTVICT);
			char_from_room(pl);
		...
		{
			act("$n grabs you by the throat and glares coldly into your eyes.", FALSE, ch, 0, pl, TO_VICT);
			act("$n grabs $N by the throat and glares coldly into $S eyes.", FALSE, ch, 0, pl, TO_NOTVICT);
...
int bs_guildguard_antiwar(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	if ((ch->in_room == real_room(7669)) && (cmd == CMD_NORTH))
	{
		...
		{
			act("$n slaps you savagely across the face.", FALSE, ch, 0, pl, TO_VICT);
			act("$n slaps $N savagely across the face.", TRUE, ch, 0, pl, TO_NOTVICT);
			...
			if ((GET_HIT(pl) - dam) < -10)
			{
				...
				act("The force of the blow proves too much for $N!", TRUE, ch, 0, pl, TO_NOTVICT);
				logit(LOG_DEATH, "%s killed by %s's slap in room %d.", GET_NAME(pl), GET_NAME(ch), world[ch->in_room].number);
				die(pl);
				return TRUE;
			}
			GET_HIT(pl) -= dam;
...
int bs_guildguard_monk(P_char ch, P_char pl, int cmd, char *arg)
{
	...
	if ((ch->in_room == real_room(22487)) && (cmd == CMD_WEST))
	{
		if (GET_CLASS(pl) == CLASS_MONK)
		{
			snprintf(buf, MAX_STRING_LENGTH, "door");
			do_open(ch, buf, 0);
			act("The $n nods $s head at you and steps aside for you to pass.", FALSE, ch, 0, pl, TO_VICT);
			act("The $n nods $s head at $N and steps aside for $M to pass.", TRUE, ch, 0, pl, TO_NOTVICT);
			mobsay(ch, "Go forward, sibling.");
			act("You enter the guild, nodding to $n as you pass.", FALSE, ch, 0, pl, TO_VICT);
			act("$N enters the guild, nodding to $n as $E passes.", TRUE, ch, 0, pl, TO_NOTVICT);
			char_from_room(pl);
		...
		else
		{
			...
			act("The $n raises $s hand and directs you in the direction from which you came.", FALSE, ch, 0, pl, TO_VICT);
			act("The $n raises $s hand and directs $N back the way $S came.", FALSE, ch, 0, pl, TO_NOTVICT);
			return TRUE;
		}
	}
	return FALSE;
...
int bs_portal(P_obj obj, P_char ch, int cmd, char *arg)
{
	...
	if (!can_enter_room(ch, to_room, FALSE) || (ch && !is_Raidable(ch, 0, 0)))
	{
	...
	else
	{
		...
		if (!IS_TRUSTED(ch))
		{
			...
			if ((GET_HIT(ch) - temp) < -10)
			{
				...
				logit(LOG_DEATH, "%s died to portal in room %d.", GET_NAME(ch), world[from_room].number);
				die(ch);
				return TRUE;
			}
			else
...
#endif
			act("You feel weakened by your passage through $p.", FALSE, ch, obj, 0, TO_CHAR);
		}
		return TRUE;
	}
}
...
int bs_child_sacrifice(P_obj obj, P_char ch, int cmd, char *arg)
{
	...
	if (!str_cmp(arg, "child") || !str_cmp(arg, "all"))
	{
		act("You attempt to pick up $p...\r\n"
		    ...
		    0,
		    TO_CHAR);
		act("As $n attempts to pick up $p, $e shudders and suddenly drops it.", TRUE, ch, obj, 0, TO_ROOM);
		...
		if (GET_HIT(ch) - dam < -10)
		{
			...
			logit(LOG_DEATH, "%s died while picking up %s in room %d.", GET_NAME(ch), obj->short_description, world[ch->in_room].number);
			die(ch);
			return TRUE;
		}
		else
	...
	for (temp = world[rroom].people; temp; temp = next)
	{
		...
		if (IS_NPC(temp) && !IS_FIGHTING(temp))
		{
			if (room == 7205)
			{
				...
				act("$n touches the wooden cross and is turned to dust.", TRUE, temp, 0, 0, TO_ROOM);
				char_from_room(temp);
			...
			else if (room == 7656)
			{
				...
				act("$n disappears into the thick forest.", TRUE, temp, 0, 0, TO_ROOM);
				char_from_room(temp);
...
int bs_altar(int room, P_char ch, int cmd, char *arg)
{
	...
	if (cmd == CMD_KNEEL)
	{
		dam      = dice(2, 8) + 5;
		move_sub = dice(2, 20);
		act("As you kneel before this sigil of black power a feeling of", FALSE, ch, 0, 0, TO_CHAR);
		act("dizzyness overcomes you. You black out as you fall to the", FALSE, ch, 0, 0, TO_CHAR);
		act("cold marble floor...", FALSE, ch, 0, 0, TO_CHAR);
		act("$N kneels before the altar and is suddenly overcome by a", TRUE, ch, 0, 0, TO_ROOM);
		act("wave dizziness. $N falls to the ground and disappears.", TRUE, ch, 0, 0, TO_ROOM);
		SET_POS(ch, POS_PRONE + GET_STAT(ch));
		char_from_room(ch);
		char_to_room(ch, real_room(22495), -2);
		if ((GET_HIT(ch) - dam) < -10)
		{
			act("The power of the altar has destroyed your body...", FALSE, ch, 0, 0, TO_CHAR);
			act("$N suddenly appears in the room, well $S corpse anyhow...", TRUE, ch, 0, 0, TO_ROOM);
			logit(LOG_DEATH, "%S killed by altar in %d.", GET_NAME(ch), world[ch->in_room].number);
			die(ch);
			return TRUE;
		}
		else
		{
			...
			act("The unconscious form of $N suddenly appears in the room.", TRUE, ch, 0, 0, TO_ROOM);
			act("$N awakens.", TRUE, ch, 0, 0, TO_ROOM);
			act("You wake to find yourself in a darkened chamber.", FALSE, ch, 0, 0, TO_CHAR);
			return TRUE;
		}
	}
	return FALSE;
...
int bs_whirlpool(int room, P_char ch, int cmd, char *arg)
{
	...
	if (cmd == CMD_PERIODIC)
	{
		for (victim = world[real_room0(room)].people; victim; victim = next_vict)
		{
			...
			if IS_NPC (victim)
			{
				act("You struggle furiously, but are dragged down by the whirlpool.", FALSE, victim, 0, 0, TO_CHAR);
				act("$n struggles furiously, but is dragged down into the whirlpool.", TRUE, victim, 0, 0, TO_ROOM);
				extract_char(victim);
				victim = NULL;
				continue;
			}
			if (!IS_TRUSTED(victim) && !IS_AFFECTED(victim, AFF_LEVITATE) && !IS_AFFECTED(victim, AFF_FLY))
			{
				dam = dice(1, 7) + 6;
				if ((GET_HIT(victim) - dam) < -10)
				{
					act("You struggle furiously, but are dragged down by the whirlpool.", FALSE, victim, 0, 0, TO_CHAR);
					act("$n struggles furiously, but is dragged down into the whirlpool.", TRUE, victim, 0, 0, TO_ROOM);
					logit(LOG_DEATH, "%s killed by whirlpool in %d.", GET_NAME(victim), world[victim->in_room].number);
					char_from_room(victim);
					char_to_room(victim, real_room(22424), -2);
					act("The corpse of $n washes up on the shore.", TRUE, victim, 0, 0, TO_ROOM);
					die(victim);
					return TRUE;
				}
				else
				{
					act("The whirlpool tosses you violently about.", FALSE, victim, 0, 0, TO_CHAR);
					act("The whirlpool tosses $n violently about.", TRUE, victim, 0, 0, TO_ROOM);
					GET_HIT(victim) -= dam;
	...
	else if (arg)
	{
		...
		if (!IS_TRUSTED(victim) && !IS_AFFECTED(victim, AFF_LEVITATE) && !IS_AFFECTED(victim, AFF_FLY))
		{
			if (dice(1, 100) > 85)
			{
				act("You manage to struggle free from the grasp of the whirlpool.", FALSE, victim, 0, 0, TO_CHAR);
				act("$n manages to struggle free from the grasp of the whirlpool.", TRUE, victim, 0, 0, TO_ROOM);
				return FALSE;
			}
			else
			{
				act("You struggle furiously to free yourself from the whirlpool.", FALSE, victim, 0, 0, TO_CHAR);
				act("$n struggles furiously to free $sself from the whirlpool.", TRUE, victim, 0, 0, TO_ROOM);
				CharWait(ch, 10);
				return TRUE;
			}
		}
