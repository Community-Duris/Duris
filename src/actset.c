...
#define NPOFFSET(Field) OFFSET_OF(struct npc_only_data *, Field)
  ...
  if (flag)
  {
    ...
    else if (SAME_STRING(flag, "echo") || SAME_STRING(flag, "screensize") || SAME_STRING(flag, "prompt") || SAME_STRING(flag, "law_flags") || SAME_STRING(flag, "winvis") || SAME_STRING(flag, "wimpy") || SAME_STRING(flag, "aggr") || SAME_STRING(flag, "balp") || SAME_STRING(flag, "balg") || SAME_STRING(flag, "bals") || SAME_STRING(flag, "balc") || SAME_STRING(flag, "lesson") || SAME_STRING(flag, "frags") || SAME_STRING(flag, "epics") || SAME_STRING(flag, "epic_skill_points") || SAME_STRING(flag, "prestige") || SAME_STRING(flag, "time_left_guild") || SAME_STRING(flag, "nb_left_guild") || SAME_STRING(flag, "deaths") || SAME_STRING(flag, "heaven"))
    {
      if (IS_NPC(ppl))
      {
      ...
      {
        if (SAME_STRING(flag, "heaven") && !(ppl->in_room == real_room0(GOOD_HEAVEN_ROOM) || ppl->in_room == real_room0(EVIL_HEAVEN_ROOM) || ppl->in_room == real_room0(UNDEAD_HEAVEN_ROOM) || ppl->in_room == real_room0(NEUTRAL_HEAVEN_ROOM)))
        {
          char_from_room(ppl);
