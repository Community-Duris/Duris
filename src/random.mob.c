...
struct zone_random_data
{
	...
	{ 14,
	  { RACE_GOBLIN, RACE_HUMANOID, RACE_HALFORC, RACE_ORC, RACE_LYCANTH, 0 },
	  { { 3, SPELL_ARMOR }, { 3, SPELL_BLESS } } },
	{ 18, { RACE_TROLL, RACE_OGRE, RACE_MINOTAUR, 0 }, { { 5, SPELL_REGENERATION } } },
	{ 20,
	  { RACE_FAERIE, RACE_HUMAN, RACE_GREY, 0 },
	  { { 3, SPELL_ARMOR }, { 3, SPELL_BLESS } } },
	{ 21,
	  { RACE_GOBLIN, RACE_LYCANTH, RACE_HALFORC, RACE_ORC, RACE_GIANT, RACE_TROLL, 0 },
	  { { 3, SPELL_SPIRIT_ARMOR } } },
	{ 23,
	  { RACE_PARASITE, RACE_DUERGAR, RACE_GOBLIN, RACE_HERBIVORE, 0 },
	  { { 3, SPELL_COLD_WARD }, { 4, SPELL_FIRE_WARD }, { 5, SPELL_SPIRIT_SIGHT } } },
	{ 24, { RACE_HUMAN, RACE_HUMANOID, 0 }, { { 4, SPELL_THRYMS_ICERAZOR } } },
	{ 26,
	  { RACE_HUMAN, RACE_GREY, RACE_HALFELF, RACE_CENTAUR, 0 },
	  { { 3, SPELL_ARMOR }, { 3, SPELL_BLESS } } },
	{ 27,
	  { RACE_HUMAN, RACE_HUMANOID, 0 },
	  { { 3, SKILL_EPIC_STRENGTH }, { 4, SPELL_TRUE_SEEING } } },
	{ 35,
	  { RACE_UNDEAD, RACE_GHOST, RACE_VAMPIRE, RACE_LICH, 0 },
	  { { 4, SPELL_PASS_WITHOUT_TRACE }, { 6, SPELL_VAMPIRIC_TOUCH } } },
	{ 37,
	  { RACE_HUMAN, RACE_HUMANOID, RACE_HALFELF, RACE_GNOME, 0 },
	  { { 3, SPELL_ARMOR }, { 3, SPELL_BLESS } } },
	{ 38,
	  { RACE_UNDEAD, RACE_GHOST, RACE_VAMPIRE, RACE_LICH, 0 },
	  { { 3, SPELL_PROTECT_FROM_COLD },
	    { 3, SPELL_PROTECT_FROM_FIRE },
	    { 3, SPELL_PROTECT_FROM_LIGHTNING } } },
	{ 40,
	  { RACE_ORC, RACE_HALFORC, RACE_GOBLIN, RACE_REPTILE, 0 },
	  { { 6, SPELL_CONJURE_ELEMENTAL } } },
	{ 30,
	  { RACE_INSECT, RACE_ARACHNID, RACE_ANIMAL, RACE_HERBIVORE, RACE_DEVIL, 0 },
	  { { 3, SPELL_CONCEALMENT }, { 5, SPELL_HASTE } } },
	{ 53,
	  { RACE_CENTAUR, RACE_GREY, 0 },
	  { { 2, SPELL_ARMOR }, { 2, SPELL_BLESS }, { 4, SPELL_INVIGORATE } } },
	{ 60,
	  { RACE_HUMAN, RACE_HALFLING, RACE_BARBARIAN, RACE_HALFELF, RACE_MOUNTAIN, RACE_GNOME, 0 },
	  { { 3, SPELL_ARMOR }, { 3, SPELL_BLESS }, { 5, SPELL_ENDURANCE } } },
	{ 67,
	  { RACE_CENTAUR, RACE_GREY, RACE_FAERIE, RACE_ANIMAL, 0 },
	  { { 3, SPELL_BARKSKIN }, { 5, SPELL_ENDURANCE } } },
	{ 68,
	  { RACE_DRAGON, RACE_DRAGONKIN, 0 },
	  { { 3, SPELL_GLOBE }, { 6, SPELL_STONE_SKIN }, { 9, SONG_DRAGONS } } },
	{ 73,
	  { RACE_MINOTAUR, RACE_DROW, RACE_THRIKREEN, RACE_GITHYANKI, RACE_GITHZERAI, RACE_BEHOLDER,
	    0 },
	  { { 6, SPELL_STONE_SKIN } } },
	// Zone 80 not found.
	//  {80, {RACE_GREY, RACE_CENTAUR, RACE_HALFELF, 0}, {{6, SPELL_STONE_SKIN}}},
	{ 87,
	  { RACE_GOBLIN, RACE_TROLL, RACE_DROW, RACE_ORC, RACE_LYCANTH, 0 },
	  { { 3, SPELL_SPIRIT_WARD }, { 5, SPELL_HASTE } } },
	{ 90, { RACE_DEVIL, 0 }, { { 3, SPELL_SOULSHIELD } } },
	{ 91,
	  { RACE_DEVIL, RACE_ANGEL, RACE_RAKSHASA, RACE_SGIANT, RACE_DEMON, RACE_SHADE,
	    RACE_ILLITHID, 0 },
	  { { 2, SPELL_REGENERATION }, { 4, SPELL_FLY }, { 6, SPELL_TRUE_SEEING } } },
	{ 93,
	  { RACE_FAERIE, RACE_DROW, RACE_GREY, RACE_HARPY, RACE_RAKSHASA, RACE_GITHYANKI,
	    RACE_GITHZERAI, 0 },
	  { { 2, SPELL_STRENGTH }, { 2, SPELL_AGILITY }, { 4, SPELL_MINOR_GLOBE } } },
	{ 94,
	  { RACE_ORC, RACE_HALFORC, RACE_GIANT, RACE_HUMAN, RACE_MINOTAUR, 0 },
	  { { 2, SPELL_SPIRIT_ARMOR }, { 4, SPELL_SPIRIT_WARD }, { 6, SPELL_PANTHERSPEED } } },
	{ 103,
	  { RACE_ORC, RACE_HALFORC, 0 },
	  { { 2, SPELL_SPIRIT_ARMOR }, { 4, SPELL_SPIRIT_WARD } } },
	{ 106,
	  { RACE_ORC, RACE_HALFORC, RACE_GOBLIN, RACE_MINOTAUR, RACE_DUERGAR, 0 },
	  { { 2, SPELL_SPIRIT_ARMOR }, { 4, SPELL_SPIRIT_WARD } } },
	{ 112,
	  { RACE_ILLITHID, RACE_GITHYANKI, 0 },
	  { { 2, SPELL_ENHANCED_AGI }, { 3, SPELL_FLESH_ARMOR }, { 4, SPELL_INTELLECT_FORTRESS } } },
	{ 113,
	  { RACE_TROLL, RACE_OGRE, RACE_GIANT, RACE_RAKSHASA, RACE_HUMANOID, RACE_LYCANTH, 0 },
	  { { 3, SPELL_REGENERATION }, { 5, SPELL_ENDURANCE }, { 7, SPELL_PASS_WITHOUT_TRACE } } },
	{ 124,
	  { RACE_DEMON, RACE_DEVIL, RACE_HUMANOID, RACE_SHADOW, 0 },
	  { { 3, SPELL_INVISIBILITY }, { 6, SPELL_STONE_SKIN } } },
	{ 130,
	  { RACE_UNDEAD, RACE_GHOST, RACE_OGRE, RACE_DROW, RACE_VAMPIRE, RACE_LICH, 0 },
	  { { 6, SPELL_STONE_SKIN } } },
	{ 133, { RACE_ORC, RACE_CONSTRUCT, RACE_HUMANOID, 0 }, { { 6, SPELL_BATTLE_ECSTASY } } },
	{ 140,
	  { RACE_FAERIE, RACE_F_ELEMENTAL, RACE_A_ELEMENTAL, RACE_W_ELEMENTAL, RACE_E_ELEMENTAL,
	    0 },
	  { { 2, SPELL_FAERIE_SIGHT } } },
	{ 143,
	  { RACE_UNDEAD, RACE_GHOST, RACE_VAMPIRE, RACE_GARGOYLE, RACE_PHANTOM, RACE_REVENANT,
	    RACE_SHADE, 0 },
	  { { 6, SPELL_VAMPIRIC_TOUCH } } },
	{ 151,
	  { RACE_DRAGON, RACE_DRAGONKIN, RACE_UNDEAD, RACE_DRACOLICH, RACE_GHOST, RACE_WIGHT,
	    RACE_REVENANT, 0 },
	  { { 6, SPELL_STONE_SKIN } } },
	{ 152,
	  { RACE_OGRE, RACE_TROLL, RACE_ORC, 0 },
	  { { 2, SPELL_SPIRIT_ARMOR }, { 3, SPELL_SPIRIT_WARD }, { 4, SPELL_ELEPHANTSTRENGTH } } },
	{ 159, { RACE_DRAGONKIN, RACE_DRAGON, 0 }, { { 6, SPELL_STORNOGS_SPHERES } } },
	{ 160,
	  { RACE_HUMAN, RACE_HALFLING, 0 },
	  { { 4, SPELL_THORNSKIN }, { 6, SPELL_ENDURANCE } } },
	{ 162,
	  { RACE_DEVIL, RACE_FAERIE, RACE_ORC, RACE_GIANT, RACE_ILLITHID, 0 },
	  { { 5, SPELL_INVISIBILITY } } },
	// Woodseer
	{ 165,
	  { RACE_HALFLING, 0 },
	  { { 2, SPELL_BARKSKIN }, { 3, SPELL_BLESS }, { 6, SPELL_ENDURANCE } } },
	// Khildarak
	{ 170,
	  { RACE_DUERGAR, 0 },
	  { { 2, SPELL_ARMOR }, { 2, SPELL_BLESS }, { 4, SPELL_STRENGTH } } },
	{ 183, { RACE_UNDEAD, RACE_DEMON, 0 }, { { 4, SPELL_FIRESHIELD } } },
	{ 191,
	  { RACE_ANIMAL, RACE_REPTILE, RACE_SNAKE, RACE_INSECT, RACE_FLYING_ANIMAL, RACE_QUADRUPED,
	    RACE_HERBIVORE, RACE_CARNIVORE, 0 },
	  { { 4, SPELL_RAVENFLIGHT } } },
	{ 196,
	  { RACE_DRAGON, RACE_BEHOLDER, RACE_DRAGONKIN, 0 },
	  { { 3, SPELL_GREATER_SPIRIT_SIGHT },
	    { 6, SPELL_GREATER_SPIRIT_WARD },
	    { 9, SONG_DRAGONS } } },
	{ 197,
	  { RACE_GITHYANKI, RACE_GITHZERAI, RACE_ILLITHID, RACE_DEMON, RACE_BEHOLDER, 0 },
	  { { 7, SPELL_BIOFEEDBACK } } },
	{ 200,
	  { RACE_ORC, RACE_HALFORC, RACE_DRAGONKIN, 0 },
	  { { 2, SPELL_ARMOR }, { 5, SPELL_VITALITY } } },
	{ 202, { RACE_HUMAN, 0 }, { { 3, SPELL_BARKSKIN } } },
	{ 213, { RACE_DROW, 0 }, { { 3, SPELL_PROT_FROM_UNDEAD }, { 5, SPELL_MINOR_GLOBE } } },
	{ 215,
	  { RACE_HUMAN, RACE_GREY, RACE_HALFELF, RACE_HUMANOID, 0 },
	  { { 3, SPELL_BARKSKIN }, { 6, SPELL_ENDURANCE }, { 9, SPELL_PASS_WITHOUT_TRACE } } },
	{ 220,
	  { RACE_BARBARIAN, RACE_ANIMAL, 0 },
	  { { 6, SPELL_PANTHERSPEED }, { 6, SPELL_LIONRAGE } } },
	{ 222,
	  { RACE_HUMAN, RACE_HALFORC, RACE_ORC, RACE_GREY, RACE_HALFELF, RACE_HALFLING, 0 },
	  { { 4, SPELL_HASTE } } },
	...
	{ 230,
	  { RACE_DEVIL, RACE_DEMON, RACE_GOLEM, RACE_CONSTRUCT, 0 },
	  { { 3, SPELL_GLOBE }, { 4, SPELL_FLY }, { 5, SPELL_DETECT_INVISIBLE } } },
	...
	{ 262,
	  { RACE_HUMAN, RACE_HALFELF, RACE_GREY, RACE_MOUNTAIN, RACE_GNOME, 0 },
	  { { 3, SPELL_DETECT_MAGIC }, { 3, SPELL_FARSEE }, { 5, SPELL_LEVITATE } } },
	{ 264, { RACE_HUMANOID, 0 }, { { 6, SPELL_SHADOW_SHIELD } } },
	{ 266,
	  { RACE_DEMON, RACE_GITHYANKI, RACE_DRAGONKIN, RACE_BEHOLDER, 0 },
	  { { 3, SPELL_NEG_ENERGY_BARRIER }, { 5, SPELL_NEG_ARMOR } } },
	{ 270,
	  { RACE_HARPY, RACE_GIANT, RACE_MOUNTAIN, RACE_TROLL, 0 },
	  { { 3, SPELL_ENDURANCE } } },
	{ 285,
	  { RACE_ANIMAL, RACE_REPTILE, RACE_SNAKE, RACE_INSECT, RACE_FLYING_ANIMAL, RACE_QUADRUPED,
	    RACE_HERBIVORE, RACE_CARNIVORE, 0 },
	  { { 3, SPELL_ARMOR }, { 3, SPELL_BLESS }, { 5, SPELL_ENDURANCE } } },
	{ 289,
	  { RACE_ORC, RACE_HALFORC, RACE_GIANT, RACE_GOLEM, RACE_DEMON, RACE_MOUNTAIN, RACE_DUERGAR,
	    0 },
	  { { 3, SPELL_ENHANCED_STR }, { 6, SPELL_STONE_SKIN } } },
	// Gnome Village - Harrow
	{ 294, { RACE_GNOME, 0 }, { { 3, SPELL_ARMOR }, { 3, SPELL_DETECT_MAGIC } } },
	{ 306,
	  { RACE_ANIMAL, RACE_HERBIVORE, RACE_HALFLING, RACE_GREY, 0 },
	  { { 3, SPELL_BARKSKIN } } },
	{ 308, { RACE_SGIANT, RACE_GIANT, 0 }, { { 4, SPELL_ENDURANCE } } },
	{ 311, { RACE_HARPY, RACE_GARGOYLE, 0 }, { { 4, SPELL_FLY } } },
	{ 313,
	  { RACE_FAERIE, RACE_ANGEL, RACE_DEVIL, RACE_A_ELEMENTAL, 0 },
	  { { 6, SPELL_INVISIBILITY } } },
	{ 315,
	  { RACE_W_ELEMENTAL, RACE_FAERIE, 0 },
	  { { 2, SPELL_WATERBREATH }, { 5, SPELL_INVISIBILITY }, { 8, SPELL_STORNOGS_SPHERES } } },
	{ 318,
	  { RACE_BARBARIAN, RACE_GIANT, RACE_CARNIVORE, 0 },
	  { { 3, SPELL_COLD_WARD }, { 5, SPELL_COLDSHIELD } } },
	{ 320,
	  { RACE_DEVIL, 0 },
	  { { 3, SPELL_FLY }, { 6, SPELL_TRUE_SEEING }, { 8, SPELL_INFERNAL_FURY } } },
	{ 324, { RACE_DEVIL, 0 }, { { 4, SPELL_DAZZLE }, { 6, SPELL_BLUR } } },
	{ 328,
	  { RACE_ILLITHID, RACE_GITHYANKI, RACE_GIANT, RACE_DEMON, 0 },
	  { { 3, SPELL_FLESH_ARMOR }, { 5, SPELL_INTELLECT_FORTRESS } } },
	{ 333,
	  { RACE_PSBEAST, RACE_SHADE, RACE_UNDEAD, RACE_LYCANTH, RACE_GHOST, 0 },
	  { { 3, SPELL_PROT_FROM_UNDEAD } } },
	{ 335,
	  { RACE_VAMPIRE, RACE_UNDEAD, RACE_GHOST, RACE_REVENANT, RACE_PDKNIGHT, RACE_LICH, 0 },
	  { { 3, SPELL_PROT_FROM_UNDEAD } } },
	{ 342,
	  { RACE_DUERGAR, RACE_GIANT, RACE_ARACHNID, 0 },
	  { { 3, SPELL_STRENGTH }, { 6, SPELL_CONCEALMENT } } },
	{ 345,
	  { RACE_VAMPIRE, RACE_UNDEAD, 0 },
	  { { 4, SPELL_DETECT_INVISIBLE }, { 4, SPELL_INVISIBILITY } } },
	{ 360,
	  { RACE_DEMON, RACE_DROW, RACE_DUERGAR, RACE_GITHYANKI, RACE_PDKNIGHT, 0 },
	  { { 3, SPELL_ENDURANCE }, { 6, SPELL_CONCEALMENT } } },
	{ 367,
	  { RACE_VAMPIRE, RACE_UNDEAD, RACE_DROW, RACE_DUERGAR, RACE_DRACOLICH, 0 },
	  { { 5, SPELL_STONE_SKIN } } },
	{ 368,
	  { RACE_VAMPIRE, RACE_UNDEAD, RACE_DROW, RACE_DUERGAR, RACE_WIGHT, RACE_REVENANT,
	    RACE_DRACOLICH, 0 },
	  { { 3, SPELL_PROT_FROM_UNDEAD }, { 5, SPELL_SOULSHIELD } } },
	...
	{ 386,
	  { RACE_DROW, RACE_DUERGAR, RACE_DEVIL, RACE_DEMON, 0 },
	  { { 3, SPELL_COLD_WARD }, { 5, SPELL_GLOBE } } },
	{ 387, { RACE_DEVIL, RACE_DEMON, RACE_DRAGON, 0 }, { { 5, SPELL_BIOFEEDBACK } } },
	{ 391,
	  { RACE_BARBARIAN, RACE_HUMAN, 0 },
	  { { 3, SPELL_PROTECT_FROM_COLD }, { 4, SPELL_SPIRIT_ARMOR }, { 5, SPELL_ENDURANCE } } },
	{ 400, { RACE_HUMAN, RACE_HUMANOID, 0 }, { { 3, SPELL_ARMOR }, { 3, SPELL_BLESS } } },
	{ 402,
	  { RACE_HUMAN, RACE_HUMANOID, RACE_GOBLIN, RACE_HALFELF, RACE_HALFORC, 0 },
	  { { 3, SPELL_BARKSKIN } } },
	{ 412,
	  { RACE_UNDEAD, 0 },
	  { { 3, SPELL_PROT_FROM_UNDEAD }, { 4, SPELL_VITALITY }, { 5, SPELL_SOULSHIELD } } },
	{ 419,
	  { RACE_BARBARIAN, RACE_ANIMAL, RACE_ARACHNID, 0 },
	  { { 3, SPELL_BARKSKIN }, { 5, SPELL_ENDURANCE }, { 7, SPELL_INVISIBILITY } } },
	{ 441, { RACE_GITHZERAI, 0 }, { { 6, SPELL_CHAOS_SHIELD } } },
	{ 448,
	  { RACE_ANGEL, RACE_DEVIL, RACE_DEMON, RACE_SGIANT, 0 },
	  { { 2, SPELL_BLESS }, { 4, SPELL_SOULSHIELD }, { 6, SPELL_VITALITY } } },
	{ 450,
	  { RACE_GREY, RACE_CENTAUR, RACE_HALFELF, 0 },
	  { { 3, SPELL_BARKSKIN }, { 6, SPELL_ENDURANCE } } },
	...
	{ 583,
	  { RACE_HUMAN, RACE_VAMPIRE, RACE_UNDEAD, RACE_GHOST, RACE_REVENANT, RACE_LICH,
	    RACE_PDKNIGHT, 0 },
	  { { 8, SPELL_VAMPIRE } } },
	...
	{ 710,
	  { RACE_HUMAN, RACE_ORC, RACE_HALFORC, RACE_MINOTAUR, RACE_HUMANOID, 0 },
	  { { 6, SPELL_STONE_SKIN } } },
	{ 756,
	  { RACE_HUMAN, RACE_LICH, RACE_BARBARIAN, RACE_PHANTOM, RACE_DEMON, RACE_UNDEAD, 0 },
	  { { 3, SPELL_PROT_FROM_UNDEAD }, { 7, SPELL_STONE_SKIN } } },
	{ 758, { RACE_HUMAN, RACE_HARPY, RACE_MOUNTAIN, RACE_HALFELF, 0 }, { { 5, SPELL_FLY } } },
	// Rift Valley Jungle
	{ 800,
	  { RACE_GREY, RACE_HALFLING, RACE_SNAKE, RACE_CARNIVORE, RACE_HERBIVORE,
	    RACE_FLYING_ANIMAL, RACE_ARACHNID, 0 },
	  { { 3, SPELL_BLESS }, { 3, SPELL_BARKSKIN }, { 6, SPELL_ENDURANCE } } },
	{ 824,
	  { RACE_HUMAN, RACE_GREY, RACE_HALFELF, RACE_RAKSHASA, RACE_CENTAUR, RACE_MOUNTAIN, 0 },
	  { { 6, SPELL_VITALITY } } },
	//{856, {RACE_UNDEAD, RACE_GHOST, RACE_ORC, RACE_REVENANT, RACE_SHADE, 0}, {{6, SPELL_STONE_SKIN}}},
	{ 857,
	  { RACE_SGIANT, RACE_GIANT, RACE_DRAGONKIN, RACE_HUMAN, 0 },
	  { { 3, SPELL_SPIRIT_ARMOR }, { 4, SPELL_SPIRIT_WARD }, { 5, SPELL_ENDURANCE } } },
	{ 936,
	  { RACE_HUMAN, RACE_HALFORC, RACE_HALFELF, 0 },
	  { { 3, SPELL_PROTECT_FROM_LIVING }, { 5, SPELL_HASTE } } },
	{ 955,
	  { RACE_MOUNTAIN, 0 },
	  { { 3, SPELL_ARMOR }, { 3, SPELL_BLESS }, { 5, SPELL_STRENGTH } } },
	{ 960,
	  { RACE_GIANT, RACE_SGIANT, RACE_TROLL, 0 },
	  { { 3, SPELL_FLY }, { 6, SPELL_STONE_SKIN } } },
	{ 964,
	  { RACE_ILLITHID, RACE_DROW, 0 },
	  { { 6, SPELL_FLESH_ARMOR }, { 6, SPELL_INTELLECT_FORTRESS } } },
	// Shady Grove (orc ht)
	{ 975, { RACE_ORC, RACE_HALFORC, 0 }, { { 3, SPELL_ARMOR }, { 6, SPELL_ENDURANCE } } },
	{ 987,
	  { RACE_VAMPIRE, RACE_SHADE, RACE_PDKNIGHT, RACE_LICH, RACE_PHANTOM, RACE_WIGHT, 0 },
	  { { 4, SPELL_PROT_FROM_UNDEAD } } },
	// Tharnadia (human ht)
...
void do_namedreport(P_char ch, char *argument, int cmd)
{
	...
	for (size_t i = 0; i < ARRAY_SIZE(zones_random_data); i++)
	{
		...
		snprintf(buffer, ARRAY_SIZE(buffer), " %s    &+W|&n ",
		...
		for (size_t x = 0; x < ARRAY_SIZE(zones_random_data[i].proc_spells); x++)
		{
			    ...
			    zones_random_data[i].proc_spells[x][1] <= MAX_AFFECT_TYPES)
			{
				struct
				{
					int spellNum;
					const char *color;
				} spellColors[] = { { SPELL_STONE_SKIN, "&+G" },
						    { SPELL_INVIGORATE, "&+G" },
				...
				snprintf(buf, ARRAY_SIZE(buf), "%s%s%s &+W(&+Y%d&+W)&n",
					 x != 0 ? "&+W,&n " : "", spellColor,
...
P_char create_random_mob(int theme, int mob_level)
{
	...
	if (theme == -1)
	{
		if (number(0, 4) && IS_HUMANOID(random_mob))
		{
			...
			snprintf(t_buf, MAX_STRING_LENGTH, "&+W%s&+w the&n %s %s &+Wfrom %s&n.",
				 temp_name, race_name, class_name, the_zone->name);
			random_mob->player.long_descr = str_dup(t_buf);

			// Short
			random_mob->only.npc->str_mask |= STRUNG_DESC2;

			snprintf(t_buf, MAX_STRING_LENGTH, "%s the %s %s", temp_name, race_name,
				 class_name);
			random_mob->player.short_descr = str_dup(t_buf);
			// name!
			random_mob->only.npc->str_mask |= STRUNG_KEYS;

			snprintf(t_buf, MAX_STRING_LENGTH, "%s %s %s", temp_name,
				 strip_ansi(race_name).c_str(), strip_ansi(class_name).c_str());
			random_mob->player.name = str_dup(t_buf);
		}
		else
		{
			random_mob->only.npc->str_mask |= STRUNG_DESC1;
			snprintf(t_buf, MAX_STRING_LENGTH, "%s %s %s &+Wfrom %s&n.",
				 prefix_name[prefix], race_name, class_name, the_zone->name);
			random_mob->player.long_descr = str_dup(t_buf);

			// Short
			random_mob->only.npc->str_mask |= STRUNG_DESC2;

			snprintf(t_buf, MAX_STRING_LENGTH, "%s %s %s", prefix_name[prefix],
				 race_name, class_name);
			random_mob->player.short_descr = str_dup(t_buf);
			// name!
			random_mob->only.npc->str_mask |= STRUNG_KEYS;

			snprintf(t_buf, MAX_STRING_LENGTH, "%s %s", strip_ansi(race_name).c_str(),
				 strip_ansi(class_name).c_str());
			random_mob->player.name = str_dup(t_buf);
		}
	}
	else
	{
		...
		snprintf(t_buf, MAX_STRING_LENGTH, "%s %s %s", prefix_name_theme[theme][prefix],
			 race_name, class_name);
		random_mob->player.short_descr = str_dup(t_buf);
		// name!
		random_mob->only.npc->str_mask |= STRUNG_KEYS;
	...
	else
	{
		debug("Created level(%d): %s in %s (%d)", GET_LEVEL(random_mob),
		      random_mob->player.long_descr, world[random_mob->in_room].name,
		      world[random_mob->in_room].number);
	}

	GET_HOME(random_mob) = GET_BIRTHPLACE(random_mob) = GET_ORIG_BIRTHPLACE(random_mob) =
		world[random_mob->in_room].number;
...
int find_mob_map_room(P_char random_mob)
{
	...
	do
	{
		...
		tries++;
		  ...
		  world[to_room].sector_type == SECT_WATER_NOSWIM || !IS_MAP_ROOM(to_room)) &&
		 tries < 2000);
