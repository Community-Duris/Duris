...
#define AFFTYPE_ARAMUS_CROWN_REGENERATION AFFTYPE_CUSTOM1
...
#define SPELL_DIVINE_WARDING 681
#define SPELL_MASS_PURIFICATION 682
#define LAST_SPELL SPELL_MASS_PURIFICATION
