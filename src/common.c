	  "&+GDr&+Lag&+Gon&n &+MLa&n&+Lnc&+Mer&n", "" } // Dragoon
};
/*
...
const char *weapons[/*TOTALATTACK_TYPES */] = { "Hit",	 "Bludgeon", "Pierce", "Slash",
						"Whip",	 "Claw",     "Bite",   "Sting",
						"Crush", "Pound",    "Maul",   "Thrash",
						"Blast", "Punch",    "Stab",   "\n" };
...
const char *dirs2[NUM_EXITS + 1] = {
	...
	"the northwest", "the southwest", "the northeast", "the southeast", "\n"
};

const char *short_dirs[NUM_EXITS + 1] = {
	"n", "e", "s", "w", "u", "d", "nw", "sw", "ne", "se", "\n"
};
...
const char *where[] = { "<used as light>      ", "<worn on finger>     ", "<worn on finger>     ",
			...
			"<worn on hands>      ", "<worn on arms>       ", "<held as shield>     ",
			"<worn about body>    ", "<worn about waist>   ", "<worn around wrist>  ",
			"<worn around wrist>  ", "<primary weapon>     ", "<secondary weapon>   ",
			"<held>               ", "<worn on eyes>       ", "<worn on face>       ",
			"<worn in ear>        ", "<worn in ear>        ", "<worn as quiver>     ",
			"<worn as a badge>    ", "<third weapon>       ", "<fourth weapon>      ",
			"<worn on back>       ", "<worn on belt buckle>", "<attached to belt>   ",
			"<attached to belt>   ", "<worn on lower arms> ", "<worn on lower hands>",
			"<worn on lower wrist>", "<worn on lower wrist>", "<worn on horse body> ",
			"<worn on rear legs>  ", "<worn on tail>       ", "<worn on rear feet>  ",
			"<worn in nose>       ", "<worn on horns>      ", "<floating about head>",
			"<worn on spider body>" };
...
const int drink_aff[][3] = { { 0, 0, 10 }, /* * Water    */
			     { 3, 2, 5 }, /* * beer     */
			     { 5, 2, 5 }, /* * wine     */
			     { 2, 2, 5 }, /* * ale      */
			     { 1, 2, 5 }, /* * ale      */
			     ...
			     { 0, 1, 5 }, /* * coke      */
			     { 0, 0, 10 }, /* * new water */
			     { 0, 1, 10 }, { 0, 1, 1 }, { 0, 1, 1 }, { 0, 1, 1 },
			     { 0, 1, 1 },  { 0, 1, 1 }, { 2, 1, 1 }, { 0, 1, 1 },
			     { 0, 1, 1 },  { 5, 1, 1 }, { 0, 0, 0 }, /* poison       */
			     { 0, 0, 10 }, { 6, 0, 2 } };

const char *color_liquid[] = {
	"clear",       "&+ybrown&N", "clear",	   "&+ybrown&N", "&+Ldark&N",
	"&+Ygolden&N", "&+rred&N",   "&+ggreen&N", "clear",	 "&+Glight green&N",
	"&+Wwhite&N",  "&+ybrown&N", "&+Lblack&N", "&+rred&N",	 "clear",
	"&+Lblack&N",  "clear",	     "clear",	   "&+ybrown&N", "&+ybrown&N",
	"&+Wwhite&N",  "grey",	     "grey",	   "clear",	 "&+Lblack&N",
	"clear",       "clear",	     "&+ggreen&n", "clear",	 "clear"
};

const char *item_types[] = { "UNDEFINED", "LIGHT",	 "SCROLL",	"WAND",	     "STAFF",
			     "WEAPON",	  "FIRE WEAPON", "MISSILE",	"TREASURE",  "ARMOR",
			     "POTION",	  "WORN",	 "OTHER",	"TRASH",     "TRAP",
			     "CONTAINER", "NOTE",	 "LIQUID CONT", "KEY",	     "FOOD",
			     "MONEY",	  "PEN",	 "BOAT",	"BOOK",	     "CORPSE",
			     "TELEPORT",  "TIMER",	 "VEHICLE",	"SHIP",	     "SWITCH",
			     "QUIVER",	  "PICK",	 "INSTRUMENT",	"SPELLBOOK", "TOTEM",
			     "STORAGE",	  "SCABBARD",	 "SHIELD",	"BANDAGE",   "SPAWNER",
			     "HERB",	  "PIPE",	 "\n" };

flagDef wear_bits[] = { { "TAKE", "Takeable", 1, 0 },
...
const char *exit_bits[] = { "IS-DOOR",	"CLOSED",   "LOCKED",	      "RSCLOSED",  "RSLOCKED",
			    "PICKABLE", "SECRET",   "BLOCKED",	      "PICKPROOF", "WALLED",
			    "SPIKED",	"ILLUSION", "WALL_BREAKABLE",
...
flagDef affected1_bits[] = { { "BLIND", "Blind", 0, 0 },
			     { "INVIS", "Invisible", 1, 0 },
			     { "FARSEE", "Farsee", 1, 0 },
...
const char *apply_types[] = {
	...
	"CURSE",    "SKILL_GRANT", "SKILL_ADD",	   "HIT_REG",	 "MOVE_REG",
	"MANA_REG", "SPELL_PULSE", "COMBAT_PULSE", "\n"
};
...
flagDef action2_bits[] = { { "COMBAT_NEARBY", "Listens for combat nearby", 1, 0 },
...
flagDef aggro3_bits[] = { { "AGGR3_OROG", ".. to orogs", 1, 0 },
...
const char *item_material[] = {
	"UNDEFINED",   "NONSUBSTANTIAL", "FLESH",	  "CLOTH",     "BARK",	    "SOFTWOOD",
	"HARDWOOD",    "SILICON",	 "CRYSTAL",	  "CERAMIC",   "BONE",	    "STONE",
	"HIDE",	       "LEATHER",	 "CURED_LEATHER", "IRON",      "STEEL",	    "BRASS",
	"MITHRIL",     "ADAMANTIUM",	 "BRONZE",	  "COPPER",    "SILVER",    "ELECTRUM",
	"GOLD",	       "PLATINUM",	 "GEM",		  "DIAMOND",   "PAPER",	    "PARCHMENT",
	"LEAVES",      "RUBY",		 "EMERALD",	  "SAPPHIRE",  "IVORY",	    "DRAGONSCALE",
	"OBSIDIAN",    "GRANITE",	 "MARBLE",	  "LIMESTONE", "LIQUID",    "BAMBOO",
	"REEDS",       "HEMP",		 "GLASSTEEL",	  "EGGSHELL",  "CHITINOUS", "REPTILESCALE",
	"GENERICFOOD", "RUBBER",	 "FEATHER",	  "WAX",       "PEARL",	    "TIN",
	"\n"
};
