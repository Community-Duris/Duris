...
const PortData ports[NUM_PORTS] = {
	{ 559633, "Flann", 559632 },	 { 635260, "Dalvik", 635660 },
	{ 88846, "Menden", 550725 },	 { 82669, "Myrabolus", 512874 },
	{ 66689, "Torrhan", 580879 },	 { 9967, "Sarmiz'Duul", 622675 },
	{ 22441, "Storm Port", 587128 }, { 49090, "Venan'Trut", 545021 },
	{ 43158, "Thur'Gurax", 616546 }, { 83786, "Deramuth", 521443 },
};
...
const ShipCrewData ship_crew_data[MAXCREWS] = {
	...
	{ "&+yM&+La&+yg&+Li&+yc&+La&+yl &+yAu&+Lto&+yma&+Lto&+yns",
	  3,
	  3000,
	  3000,
	  2000,
	  ...
	  3000,
	  { 0, 0, 0, 0, 77 },
	  CF_SCOUT_RANGE_2 | CF_MAXSPEED_1 },
	{ "&+yNorth&+Wshore &+LPirates",
	  0,
	  100,
	  100,
	  100,
	  ...
	  { 0, 0, 0, 0, 77 },
	  CF_NONE },
	{ "&+BT&+bw&+Bi&+bl&+Bi&+bg&+Bh&+bt &+LCove &+rBucaneers",
	  1,
	  300,
	  300,
	  300,
	  ...
	  { 0, 0, 0, 0, 77 },
	  CF_NONE },
	{ "&+yMa&+Lra&+yud&+Ler&+ys &+Lof the &+cFo&+Cur &+wWi&+Wnds",
	  2,
	  1000,
	  1000,
	  1000,
	...
	{ "&+GEv&+ge&+Grm&+gee&+Gt &+BCoasters",
	  ...
	  { 43222, 0, 0, 0, 77 },
	  CF_NONE },
	{ "&+WTh&+wa&+Wrn&+wa&+Wdi&+wa&+Wn &+WR&+wi&+Wgg&+we&+Wrs",
	  0,
	  150,
	  80,
	  100,
	...
	{ "&+GStr&+go&+Gng&+ga&+Grms &+go&+Gf &+GGh&+go&+Gr&+ge ",
	  0,
	  0,
	  0,
	  0,
	...
	{ "&+WSto&+wrm&+bPort &+rBucaneers",
	  ...
	  { 22481, 0, 0, 0, 77 },
	  CF_NONE },
	{ "&+yJu&+wgg&+yer&+Wna&+wug&+Wh&+wt &+LDeserters",
	  1,
	  500,
	  500,
	  350,
	...
	{ "&+rQuietus &+WPo&+Lwd&+wer &+wMo&+Lnk&+wey&+Ls",
	  1,
	  500,
	  800,
	  400,
	...
	{ "&+MMirabolan &+YMer&+Wcha&+Ynt&+Ws",
	  ...
	  { 82641, 0, 0, 0, 77 },
	  CF_MAXCARGO_10 },
	{ "&+WCo&+wr&+Wwe&+wl&+Wl &+CS&+ce&+Ba &+cD&+Bog&+bs",
	  2,
	  1500,
	  1550,
	  1250,
	...
	{ "&+RBoyard &+BNaval &+WGu&+wa&+Wr&+wd",
	  ...
	  { 38107, 0, 0, 0, 77 },
	  CF_WEAPONS_REPAIR_3 },
	{ "&+YVenan'Trut &+RR&+roy&+Ral &+wS&+Whi&+wp&+wwr&+Wigh&+wts",
	  2,
	  1250,
	  1300,
	  1750,
	  ...
	  1000,
	  { 49051, 0, 0, 0, 77 },
	  CF_MAXSPEED_1 | CF_HULL_REPAIR_2 },
	{ "&+cCeothian &+BSea&+Cfa&+cr&+Ce&+cr&+Cs",
	  2,
	  1600,
	  1350,
	  1250,
	  ...
	  { 81021, 0, 0, 0, 77 },
	  CF_SCOUT_RANGE_2 },
	{ "&+GJade &+MTei&+mko&+mku &+BN&+co&+Br&+ci&+Bk&+cu&+Bm&+cii&+Bn",
	  2,
	  1350,
	  1500,
	  1500,
...
const ShipChiefData ship_chief_data[MAXCHIEFS] = {
	...
	{ SAIL_CHIEF,
	  "&+yOld &+gQ&+wu&+ga&+wr&+gt&+we&+gr&+wmaster",
	  800,
	  25,
	  2,
	  3000000,
	  540,
	  { 1734, 82641, 55418, 0, 77 },
	  CCF_NONE },
	{ GUNS_CHIEF,
	  "&+BMaster &+rGu&+Rnn&+rer",
	  1000,
	  ...
	  CCF_NONE },
	{ RPAR_CHIEF,
	  "&+yVet&+Ye&+Wr&+Ya&+yn &+yB&+Yo&+Wats&+Yw&+yain",
	  900,
	  30,
	  2,
	  3500000,
	  640,
	  { 43221, 66735, 55418, 0, 77 },
	  CCF_NONE },
	...
	{ GUNS_CHIEF,
	  ...
	  CCF_NONE },
	{ RPAR_CHIEF,
	  "&+cE&+wxp&+ce&+wrt &+cE&+wng&+ci&+wn&+cee&+wr",
	  2200,
	  60,
	  3,
	  8000000,
...
#define WPNFLAG08 \
	FORE_ALLOWED | REAR_ALLOWED | PORT_ALLOWED | STAR_ALLOWED | RANGEDAM | CAPITAL // light beam
#define WPNFLAG09 \
	FORE_ALLOWED | REAR_ALLOWED | PORT_ALLOWED | STAR_ALLOWED | RANGEDAM | CAPITAL // heavy beam
#define WPNFLAG10                                                               \
	FORE_ALLOWED | REAR_ALLOWED | PORT_ALLOWED | STAR_ALLOWED | MINDBLAST | \
		CAPITAL // mind blast
...
const WeaponData weapon_data[MAXWEAPON] = {
	...
	{
		"Small Ballista", 50000, 0, 0, 3, 60, 0, 8, 2, 4, 1, 10, 12, 100, 50, 10, 30, 7,
		WPNFLAG01,
	}, // small ball
	{
		"Medium Ballista", 100000, 0, 0, 6, 50, 0, 10, 4, 6, 1, 10, 14, 100, 50, 10, 30, 8,
		WPNFLAG02,
	}, // med ball
	{
		"Large Ballista", 500000, 0, 0, 10, 30, 0, 12, 6, 9, 1, 10, 16, 100, 50, 10, 30, 10,
		WPNFLAG03,
	}, // lrg ball
	{
		"Small Catapult",
	...
	{
		"Heavy Ballista", 1000000, 0, 0, 15, 6, 0, 4, 15, 22, 1, 10, 0, 100, 0, 15, 30, 3,
		WPNFLAG07,
	}, // hvy ball
	{
		"Light Beamcannon",
...
const ShipTypeData ship_type_data[MAXSHIPCLASS] = {
	...
	{ 5, "Caravel", 4000000, 0, 200, 8, 100, 110, 35, 6, 10, 68, 13, 13, 30, 13, 12,
	  SHK_MERCHANT },
	{ 6, "Carrack", 8000000, 0, 260, 10, 130, 120, 50, 9, 15, 58, 8, 10, 35, 16, 24,
	  SHK_MERCHANT },
	{ 7, "Galleon", 12000000, 0, 330, 12, 165, 130, 70, 12, 20, 50, 6, 8, 40, 19, 40,
	  SHK_MERCHANT },
	{ 8, "Corvette", 9000000, 0, 165, 6, 82, 120, 0, 0, 6, 74, 20, 20, 31, 13, 0, SHK_WARSHIP },
	{ 9, "Destroyer", 15000000, 0, 220, 8, 110, 130, 0, 0, 8, 64, 13, 14, 36, 16, 0,
	  SHK_WARSHIP },
	{ 10, "Frigate", 22000000, 0, 285, 10, 142, 140, 0, 0, 10, 55, 8, 10, 41, 20, 0,
	  SHK_WARSHIP },
	{ 11, "Cruiser", 36000000, 0, 400, 12, 200, 160, 0, 0, 15, 48, 5, 8, 46, 25, 0,
	  SHK_WARSHIP },
...
const ShipArcProperties ship_arc_properties[MAXSHIPCLASS] = {
	...
	{ { 3, 5, 2, 5 },
	  { 51, 75, 51, 75 },
	  { 183, 229, 138, 229 },
	  { 79, 99, 49, 99 } }, // Dreadnought
	{ { 3, 5, 2, 5 },
	  { 51, 75, 51, 75 },
	  { 183, 229, 138, 229 },
	  { 79, 99, 49, 99 } } // Large Ship
};
...
const ulong arcbitmap[4] = { FORE_BIT, PORT_BIT, REAR_BIT, STAR_BIT };
