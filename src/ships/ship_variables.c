...
const WeaponData weapon_data[MAXWEAPON] = {
	...
	{
     "Medium Catapult",  800000,    0,    0, 13, 20,  5, 20,  2,  4, 5, 260, 20, 100, 100,  2, 30, 24, WPNFLAG05,
	 }, // med cat
	{
	...
	{
     "Heavy Beamcannon", 5000000, 1800, 1800,  9, 40,  0, 23,  5, 22, 1,  10, 10, 100,  30, 15, 45,  0, WPNFLAG09,
	 }, // heavy beam
	{
     "Mind Blast Cannon", 4000000, 1700, 1700,  5, 50,  0, 20,  0,  0, 1, 360,  0,   0,   0,  0, 45,  0, WPNFLAG10,
	 }, // mind blast
	{
     "Fragmentation Cannon", 5000000, 1900, 1900,  7, 20,  0, 16,  4,  6, 5,  90, 50,  50, 100,  0, 45, 12, WPNFLAG11,
	 }, // frag cannon
	{
     "Long Tom Catapult", 5000000, 2000, 2000,  9,  6, 12, 32,  3,  6, 8, 360, 20, 100, 100,  3, 45, 36, WPNFLAG12,
	 }, // long tom
};
