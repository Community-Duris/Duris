...
#define SHIP_AVAIL_CARGO_SALVAGE(shipdata) MIN(((IS_MERCHANT(ship) ? SHIP_MAX_CARGO(ship) : (SHIP_MAX_WEIGHT(ship) / 5)) - SHIP_CARGO_LOAD(shipdata)), (SHIP_AVAIL_WEIGHT(shipdata) / 2))
