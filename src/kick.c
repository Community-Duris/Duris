...
const char *att_kick_kill_ch[]     = {"Your kick caves $N's chest in, killing $M.",
                                      ...
                                      "Your fierce kick sends $N flying through the air in a lifeless arc of death."
                                          ""};
const char *att_kick_kill_victim[] = {"$n crushes you beneath $s foot, killing you.",
                                      ...
                                      ""};
const char *att_kick_kill_room[]   = {"$n strikes $N in chest, shattering the ribs beneath $M.",
...
const char *att_kick_miss_ch[]     = {"$N steps back, and your kick misses $M.",
                                      ...
                                      "$N floats deftly out of the way, avoiding your sweeping kick."
                                          ""};
const char *att_kick_miss_victim[] = {"$n misses you with $s clumsy kick at your chest.",
...
const char *att_kick_miss_room[] = {"$n misses $N with a clumsy kick.",
...
const char *att_kick_hit_ch[] = {"Your kick crashes into $N's chest.",
...
const char *att_kick_hit_victim[] = {"$n's kick crashes into your chest.",
...
const char *att_kick_hit_room[] = {"$n hits $N with a mighty kick to $S chest.",
