...
with tempfile.TemporaryDirectory(prefix="duris-flat-recipe-") as temporary:
    temporary_path = pathlib.Path(temporary)
    binary = temporary_path / "flatfile_recipe_test"
    compile_result = subprocess.run(
        [
            ...
            "-Isrc",
            "-Isrc/no_mysql",
            "tests/async/flatfile_recipe_repository_harness.cpp",
