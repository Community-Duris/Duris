...
for file in bootstrap_multithread_safe.sql immutable/0001_lookup_dataset_state.sql immutable/0001_lookup_dataset_state.sh immutable/0002_player_item_metadata_uniqueness.sql immutable/0002_player_item_metadata_uniqueness.sh immutable/0003_season_reset_state.sql immutable/0003_season_reset_state.sh immutable/0004_server_reboots.sql immutable/0004_server_reboots.sh immutable/0005_level_cap_singleton.sql immutable/0005_level_cap_singleton.sh immutable/0006_kingdom_realms.sql immutable/0006_kingdom_realms.sh immutable/0007_pkill_event_stamp_contract.sql immutable/0007_pkill_event_stamp_contract.sh immutable/0008_statistics_date_index.sql immutable/0008_statistics_date_index.sh immutable/0009_kingdom_garrison.sql immutable/0009_kingdom_garrison.sh runtime_compatibility_manifest.json verify_runtime_compatibility.sh; do
    docker cp "$ROOT/migrations/$file" "$NAME:/tmp/$(basename "$file")" >/dev/null
done
docker exec "$NAME" chmod +x /tmp/0001_lookup_dataset_state.sh /tmp/0002_player_item_metadata_uniqueness.sh /tmp/0003_season_reset_state.sh /tmp/0004_server_reboots.sh /tmp/0005_level_cap_singleton.sh /tmp/0006_kingdom_realms.sh /tmp/0007_pkill_event_stamp_contract.sh /tmp/0008_statistics_date_index.sh /tmp/0009_kingdom_garrison.sh /tmp/verify_runtime_compatibility.sh
