...
MIGRATION = ROOT / "migrations/immutable/0023_zone_story_quest_state.sql"
VERIFIER = ROOT / "migrations/immutable/0023_zone_story_quest_state.sh"
...
def main() -> None:
    ...
    assert step["id"] == "0023_zone_story_quest_state"
    assert step["sequence"] == 23
    ...
    assert runtime["current_table_count"] == 199
