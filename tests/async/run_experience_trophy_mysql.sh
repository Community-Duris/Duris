...
export ENVIRONMENT=test DB_HOST=127.0.0.1 DB_USER=root DB_NAME=experience_trophy_test
export GAME_ACCOUNT_NAME=trophy_test_account GAME_ACCOUNT_CHARACTER_NAME=TrophyTest
