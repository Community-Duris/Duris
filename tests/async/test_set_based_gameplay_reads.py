...
assert "PLAYER_LOAD_BASE_QUERY_MAX = 24" in (SRC / "player_load_repository.h").read_text()
assert "PLAYER_LOAD_RESTITUTION_QUERY_MAX = 2" in (SRC / "player_load_repository.h").read_text()
